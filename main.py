...
st.markdown("""
**Магазин автозапчастин VOLVO**  
☀️ Захистіть cвій двигун якісною оливою!  
📍 м. Львів, вул. Навроцького, 25  
📞 **Телефонуйте: 067 772 00 54    095 88 46 777**
""")
if st.button("🌐 написати"):
    st.write("volvolvivclub@gmail.com")
